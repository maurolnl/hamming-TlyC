...
public class Choose extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Proteger archivo con bloque de:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new Choose().hamminga(Inicio.ruta);
        DateChooser da = new DateChooser();
        da.setVisible(true);
        this.setVisible(false);
        JOptionPane.showMessageDialog(null, "Protegido!");
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new Choose().hammingb(Inicio.ruta);
        DateChooser da = new DateChooser();
        da.setVisible(true);
        this.setVisible(false);
        JOptionPane.showMessageDialog(null, "Protegido!");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new Choose().hammingc(Inicio.ruta);
        DateChooser da = new DateChooser();
        da.setVisible(true);
        this.setVisible(false);
        JOptionPane.showMessageDialog(null, "Protegido!");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        new Choose().hammingd(Inicio.ruta);
        DateChooser da = new DateChooser();
        da.setVisible(true);
        this.setVisible(false);
        JOptionPane.showMessageDialog(null, "Protegido!");
    ...
    private native void hamminga(String ruta);

    private native void hammingb(String ruta);

    private native void hammingc(String ruta);

    private native void hammingd(String ruta);
